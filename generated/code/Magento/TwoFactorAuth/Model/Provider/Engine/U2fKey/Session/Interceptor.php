...
class Interceptor extends \Magento\TwoFactorAuth\Model\Provider\Engine\U2fKey\Session implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getU2fChallenge');
        return $pluginInfo ? $this->___callPlugins('getU2fChallenge', func_get_args(), $pluginInfo) : parent::getU2fChallenge();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setU2fChallenge');
        $pluginInfo ? $this->___callPlugins('setU2fChallenge', func_get_args(), $pluginInfo) : parent::setU2fChallenge($challenge);
    }
